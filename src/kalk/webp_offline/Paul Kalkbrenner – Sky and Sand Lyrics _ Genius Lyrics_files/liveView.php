...
var SekindoClientDetections_URL = function (config) {
	...
	if (this.isPlayerApiActions && !this.isAmpProject && !this.isAmpIframe && !this.isApp) this.playerApiActions();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=112329&playerApiId=geniusPrimisPlayer0&cbuster=1695739818',
					origQString: 's=112329&playerApiId=geniusPrimisPlayer0',
					placementId: 112329,
					x: 608,
					y: 342,
					videoType: 'flow',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"117.0.0.0","browserVersionMajor":"117","browserVersionMinor":"0","chromeVersion":"117"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop","languages":["en"],"googlePSI":false},
					isFpCookie: 0,
					geo: 'GB',
					dmaCode: 0,
					dynamicSetup: [],
					...
					customTargetingProperties: {"objectType":"window.top","objectFunction":"getPrimisTargeting()","commitDoubleEncoding":1},
